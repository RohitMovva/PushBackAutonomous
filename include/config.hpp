...
namespace Config
{
    ...
    constexpr double WHEEL_BASE_WIDTH = 12.5;                                        ///< Distance between the left and right wheels in inches
    ...
    constexpr double DT = 10;                     ///< Global default time step in milliseconds
